    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card animated slideInUp slow">
                <div class="card-header">{{ __('Login') }} | Belum punya akun ? <a href="{{route('register')}}">Daftar Sebagai Dosen</a> | <a href="{{route('registerasdosshow')}}">Daftar Sebagai Mahasiswa</a></div>
